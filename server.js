...
mongoose.connect('mongodb+srv://andreramone:answer@projeto.3aqen.mongodb.net/AGENDA?retryWrites=true&w=majority', {useNewUrlParser: true, useUnifiedTopology: true, useFindAndModify: false}) //retorna uma promessa e os objetos são erros que geraram no node
.then(() => {
...
const sessionOptions = session({
    secret: 'dasdasdasdas+++',
    store: MongoStore.create({ mongoUrl: 'mongodb+srv://andreramone:answer@projeto.3aqen.mongodb.net/AGENDA?retryWrites=true&w=majority'}),
    resave: false,
    saveUninitialized: false,
    cookie: {
        maxAge: 1000 * 60 * 60 * 24 * 70, // 70 dias
        httpOnly: true
    },
});
